...
import { Trash2, Edit, Plus, Save, Search, Filter, Star, StarOff, Check, X, Upload, Image } from "lucide-react";
...
export default function AdminGallery() {
  ...
  const handleFileUploadComplete = async (result: { successful: Array<{ uploadURL: string; name: string }> }) => {
    for (const file of result.successful) {
      ...
      const screenshotData = {
        ...
        featured: false,
        fileName: file.name,
        fileSize: 0, // Will be updated by server
        mimeType: "image/jpeg", // Will be updated by server
      };
