        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div className="glassmorphism p-8 rounded-2xl">
              <h3 className="font-orbitron font-semibold text-2xl mb-6 text-teal-400">Resolution Options</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="download-stats p-8 rounded-2xl">
              <h3 className="font-orbitron font-semibold text-2xl mb-6 text-teal-400">Download Stats</h3>
            ...
            {/* System Requirements */}
            <div className="glassmorphism p-8 rounded-2xl">
              <h3 className="font-orbitron font-semibold text-2xl mb-6 text-teal-400">System Requirements</h3>
            ...
            {/* Quick Install */}
            <div className="glassmorphism p-8 rounded-2xl">
              <h3 className="font-orbitron font-semibold text-2xl mb-6 text-teal-400">Quick Install</h3>
